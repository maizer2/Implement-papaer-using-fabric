...
class UnetGenerator(nn.Module):
    def __init__(self, input_nc, output_nc, num_downs, ngf=64,
                 norm_layer:str = "torch.nn.BatchNorm2d", use_dropout=False):
...
class GMM(nn.Module):
    ...
    def __init__(self, grid_size, fine_height, fine_width, p_channels, c_channels):
        super().__init__()
        self.extractionA = FeatureExtraction(p_channels, ngf=64, n_layers=3, norm_layer=nn.BatchNorm2d) 
        self.extractionB = FeatureExtraction(c_channels, ngf=64, n_layers=3, norm_layer=nn.BatchNorm2d)
